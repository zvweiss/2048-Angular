# DevTools snippets for localStorage and chat continuity

## How to use this in a new chat

1. Open `docs/reports/continuity/chat-handoff.md`.
2. Paste the relevant current-state values (goal, active label, last divergence, pending next steps).
3. In the new chat, share that handoff first, then use snippets from this file as needed.
